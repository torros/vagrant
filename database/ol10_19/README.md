# Oracle 19c on Oracle Linux 10

A simple Vagrant build for Oracle Database 19c on Oracle Linux 10.
...
* [Patch 37591483: COMBO OF OJVM RU COMPONENT 19.27 + DB RU 19.27](https://support.oracle.com)
...
```
cd C:\git\oraclebase\vagrant\database\ol10_19\
vagrant up
```
